 ...
 * P层 - 视频题
 */
public class VideoPresenter extends MvpPresenter<VideoView> implements IAnswer {
...
//    private int mSelectPosition = -1;
    ...
    public VideoPresenter(@NonNull VideoView view) { super(view); }

//    @Override
//    public void onTriggerHiddenChanged(boolean hidden)
//        super.onTriggerHiddenChanged(hidden);
//        mAnswerModel.onTriggerHiddenChanged();
//        LogUtil.e(getClass().hashCode() + " hidden -> " + hidden);
////        VideoView v = getView();
////        if( v != null && !hidden ) post(v::onPlay, 800);
//    }
...
//        mSelectPosition = position;
    ...
    public void setVideoUrl() {
        VideoView v = getView();
//        mPagerData.setVideo( "https://xuexi-app.oss-cn-shenzhen.aliyuncs.com/study_test/admin/Comprehensive/FoundationLevel/Pinyin/video/ao.mp4" );
        if( v != null ) v.onCallVideoUrl( mAnswerModel.getVideo( mPagerData ) );
    }
    ...
    public void check() {
        ...
        //检查日志
        mAnswerModel.checkLog( getContext(), mPagerData );
        if( mAnswerModel.check( answerId ) ) {
            //移除错题

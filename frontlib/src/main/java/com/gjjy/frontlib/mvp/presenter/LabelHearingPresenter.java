 ...
 * P层 - 标签题-听力
 */
public class LabelHearingPresenter extends MvpPresenter<LabelHearingView> implements IAnswer {
...
//    private int mSelectPosition = -1;
    ...
    public LabelHearingPresenter(@NonNull LabelHearingView view) { super(view); }
    ...
    public void onPagerHiddenStatus(boolean hidden) {
        ...
        viewCall( LabelHearingView::onPlay, 500 );
    }
...
//        v.onCallTitle( mAnswerModel.getTitle( mPagerData ) );
    ...
    public void check() {
        ...
        if( sb.toString().equals( getAnswer() ) ) {
            //移除错题

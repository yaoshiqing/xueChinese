...
public class StartUtil {
    ...
    public static void startMsgDetailsActivity(Activity activity, int id, String title) {
    ...
    public static void startTargetedLearningDetailsActivity(long id, int topTalkId, int topInteractType) {
        ARouter.getInstance()
    ...
    public static void startExitAppLoginActivity(Activity activity) {
        ...
        StartUtil.startActivityForResult(
                activity, p, REQUEST_CODE_EXIT_LOGIN_RESULT
        );
    }
    ...
    public static void startBuyVipActivity(Activity activity, boolean isFree) {
        ...
        StartUtil.startActivityForResult(
                activity, p, isFree ? REQUEST_CODE_BUY_VIP_OF_FREE : REQUEST_CODE_BUY_VIP
        );
    }
    ...
    public static void startIntegralActivity(Activity activity) {
        ...
        StartUtil.startActivityForResult(
                activity, p, REQUEST_CODE_EXCHANGE_POINTS_RESULT
        );
    }
}

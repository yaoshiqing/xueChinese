...
public class BuriedPointEvent {
    ...
    public static BuriedPointEvent get() {
        return BuriedPointEvent.HANDLER.I;
    }
    ...
    private String toResultValue(boolean result) {
        return result ? "成功" : "失败";
    }
     ...
     * @param result  登录结果
     */
    public void onSendVerificationCodePageSaveButton(Context context, boolean result) {
        Map<String, Object> map = new HashMap<>();
        baseBuriedPoint(map, true);
        map.put("result", toResultValue(result));

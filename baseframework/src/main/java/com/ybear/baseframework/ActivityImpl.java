...
final class ActivityImpl {
    ...
    public static ActivityImpl create() { return HANDLER.I; }
    private static final class HANDLER { private static final ActivityImpl I = new ActivityImpl(); }
    ...
    void onReChangedWindowState(@Nullable Activity activity) {
        if( activity == null || mIActivity == null ) return;
        mHandler.post(() -> {
            ...
            if( v != null && SDK_INT >= android.os.Build.VERSION_CODES.KITKAT_WATCH ) {
                if( mOnSystemUiVisibilityChangeListener == null ) {
                    mOnSystemUiVisibilityChangeListener = visibility -> {
                        ...
                        if( visibility != View.VISIBLE ) onReChangedWindowState( activity );
                    };
    ...
    @Nullable
    private Window getWindow(@NonNull Activity activity) { return activity.getWindow(); }
    ...
    /**
     ...
     @return        是否启用
     */
    boolean onEnableOverridePendingTransition() { return true; }

    private void setOverridePendingTransition(@Nullable Activity activity, boolean isEnter) {
        if( activity == null || !onEnableOverridePendingTransition() ) return;
    ...
    <VP extends BaseVP> void onResume(@NonNull VP vp, @Nullable IActivity iActivity) {
        ...
        if( iActivity != null ) mIActivity = iActivity;
    ...
    void onDestroy(@Nullable Activity activity, int hashCode) {
        //在退出栈中移除当前Activity
        if( activity != null ) mStackManage.removeExitStack( activity );
        //解除DOM监听
    ...
    void setStatusBarHeightForPadding(View v) {
        if( v != null ) SysUtil.setStatusBarHeightForPadding( v );
    }
    ...
    void setStatusBarHeightForSpace(Space s) {
        if( s != null ) SysUtil.setStatusBarHeightForSpace( s );
    }
    ...
    void setCallResult(int id) { DOM.getInstance().setResult( id ); }

    void setCallResult(int id, Object data) { DOM.getInstance().setResult( id, data ); }

    ToastManage getToast() { return mToastManage; }
     ...
     */
    void setStatusBarIconColor(@Nullable Activity activity,
                               @SysUtil.StatusBarIconColor int statusBarColor) {
        mStatusBarIconColor = statusBarColor;
        Window w = null;
        if( activity != null ) w = getWindow( activity );
        if( w != null ) SysUtil.setStatusBarIconColor( w, statusBarColor );
    }
     ...
     */
    @SysUtil.StatusBarIconColor
    int onStatusBarIconColor() { return mStatusBarIconColor; }
     ...
     * @return  是否启用
     */
    boolean onEnableFullScreen() { return mEnableFullScreen; }
     ...
     * @return  是否启用
     */
    boolean onEnableImmersive() { return mEnableImmersive; }

    /**
     * 获取栈管理器（用于关闭页面，返回桌面，双击返回桌面等一系列操作）
     * @return  {@link StackManage}
     */
    StackManage getStackManage() { return mStackManage; }
    ...
    void showToast(String s, int duration, @Nullable Build b) {
        ...
        if( b != null ) obj.putParcelable( KEY_TOAST_BUILD, b );
        msg.what = WHAT_TOAST;
        msg.obj = obj;
        mHandler.sendMessage( msg );
    }
    void showToast(String s, int duration) { showToast( s, duration, null ); }
    void showToast(String s, @Nullable Build b) {
        showToast( s, ToastX.LENGTH_SHORT, b );
    }
    void showToast(String s) { showToast( s, ToastX.LENGTH_SHORT ); }

    void showToastOfLong(String s, @Nullable Build b) { showToast( s, ToastX.LENGTH_LONG, b ); }
    void showToastOfLong(String s) { showToastOfLong( s, null ); }

...
public class DialogueFragment extends BaseFragment {
    ...
    private void initData() {
        ...
        rvList.setAdapter(
                mAdapter = new TargetedLearningDetailsDialogueAdapter( getContext(), new ArrayList<>() )
        );
...
//        if( mAdapter != null ) mAdapter.playAudio();
    ...
    public void pauseAudio() { if( mAdapter != null ) mAdapter.pauseAudio(); }
...
//            );
        ...
        if( pwContentPopup.isShowing() ) return;
        ...
        if( tvPinyin != null ) tvPinyin.setText( data.getPinyin() );
        if( tvChinese != null ) tvChinese.setText( data.getContent() );
        if( tvTranslate != null ) tvTranslate.setText( data.getTranslate() );
    ...
    private void showTips(PopupWindow pw, View v, View vArrow) {
        if( getContext() == null || v == null || vArrow == null ) return;

...
import com.gjjy.discoverylib.mvp.presenter.TargetedLearningMoreListPresenter;
...
/**
 专项学习 - 更多
 */
@Route(path = "/discovery/TargetedLearningMoreListActivity")
public class TargetedLearningMoreListActivity extends BaseActivity implements TargetedLearningMoreListView {
    @Presenter
    private TargetedLearningMoreListPresenter mPresenter;
    ...
    private void initData() {
        ...
        tbToolbar.setTitle( R.string.menuImmerse );
